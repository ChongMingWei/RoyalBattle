...
Autocannon::Autocannon(QGraphicsItem * parent):QObject(),QGraphicsPixmapItem(parent)
{
    //set the health
    health =25;
    setPixmap(QPixmap(":/image/champions2/autocannon.png"));
    ...
    QPointF autocannon_center(x()+40,y()+40);
    QLineF ln(poly_center,autocannon_center);
...
double Autocannon::distanceTo(QGraphicsItem *item)
{
...
void Autocannon::acquire_target()
{
